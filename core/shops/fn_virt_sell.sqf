...
life_gesamtexp = life_gesamtexp + (_amount * 5);
};
if (_type in _Haschoel) then {
life_gesamtexp = life_gesamtexp + (_amount * 4);
};
if (_type in _Gold) then {
life_gesamtexp = life_gesamtexp + (_amount * 8);
};
if (_type in _Fladen) then {
life_gesamtexp = life_gesamtexp +  (_amount * 2);
};
