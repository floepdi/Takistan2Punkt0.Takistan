...
if(!_isVehicle) then {
	...
	if(_dice < 30) then {
		...
		if ((typeOf cursorTarget in ["rhsusf_m998_d_2dr","rhsusf_m998_d_4dr","DAR_M1152","rhsusf_m1025_d_m2","DAR_M1165_GMV","DAR_M1151","DAR_M1151_Deploy","DAR_M1167","rhsusf_m113d_usarmy"]) && (life_quest == 41)) then {
			ADD(life_questinfo,1);
		};
