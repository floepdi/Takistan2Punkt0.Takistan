...
switch (playerSide) do
{
	case civilian:
	{
		...
		life_actions = life_actions + [player addAction["Fahrzeug flippen",life_fnc_flipaction,"",0,false,false,"",'!isNull cursorTarget  && cursortarget isKindOf "Landvehicle"  && speed cursorTarget < 2 && speed player < 5 && (vectorUp cursorTarget select 2 < 5)']];
